...
setuptools.setup(
    ...
    ext_modules=[input_stream_ext()],
    cmdclass={'build_ext': input_stream_build_ext},
    test_suite='test',
    tests_require=[
        'boto3'
    ]
